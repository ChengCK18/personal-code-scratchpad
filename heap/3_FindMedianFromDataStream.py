...
#         insertMaxHeap(num)
#         if((len(self.maxHeap)>=1 and len(self.minHeap)>=1 and self.minHeap[0]<self.maxHeap[0])): # to balance both heap length
...
#         if(abs(len(self.maxHeap) - len(self.minHeap))>=2): # to balance both heap length
